...
class MkfeatManager {
  ...
  extract = (payload) => {
    return new Promise(async (resolve, reject) => {
      try {
        const result = await axios.default.post(`${this[ENDPOINT]}/extract`, payload);
  ...
  importance = (payload) => {
    return new Promise(async (resolve, reject) => {
      try {
        const result = await axios.default.post(`${this[ENDPOINT]}/importance`, payload);
        if(!result.data || !result.data.tid) {
          throw new Error("Cannot detect tid from response");
        }
  ...
  getImportanceProgress = () => {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const result = await axios.default.get(`${this[ENDPOINT]}/importance/${this[IMPORTANCE_TID]}/status`)
  ...
  getImportanceResult = () => {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const result = await axios.default.get(`${this[ENDPOINT]}/importance/${this[IMPORTANCE_TID]}`)
        if(!result.data) {
          throw new Error("Cannot detect tid from response");
        }
        resolve(result.data)
  ...
  stopImportanceJob = () => {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const result = await axios.default.put(`${this[ENDPOINT]}/importance/${this[IMPORTANCE_TID]}/stop`)
        resolve(result)
      } catch(err) {
        reject(err)
      }
  ...
  deleteImportanceJob = () => {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const result = await axios.default.delete(`${this[ENDPOINT]}/importance/${this[IMPORTANCE_TID]}`)
        resolve(result)
      } catch (err) {
        // console.log(err)
        reject(err)
   ...
   */
  batchExtractJob = async (payload, progressCallback) => {
    return new Promise( async (resolve, reject) => {
      try {
